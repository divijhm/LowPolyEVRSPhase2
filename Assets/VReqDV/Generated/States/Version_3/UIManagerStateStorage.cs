...
namespace Version_3
{
    public static class UIManagerStateStorage
    {
        ...
        public static bool IsCard6_angleAlignment(GameObject obj) => stateTable[obj] == UIManagerStateEnum.Card6_angleAlignment;
        public static bool IsCard7_needleInsertion(GameObject obj) => stateTable[obj] == UIManagerStateEnum.Card7_needleInsertion;
        public static bool IsCard8_plungerPress(GameObject obj) => stateTable[obj] == UIManagerStateEnum.Card8_plungerPress;
        ...
        public static void SetCard6_angleAlignment(GameObject obj) => SetState(obj, UIManagerStateEnum.Card6_angleAlignment);
        public static void SetCard7_needleInsertion(GameObject obj) => SetState(obj, UIManagerStateEnum.Card7_needleInsertion);
        public static void SetCard8_plungerPress(GameObject obj) => SetState(obj, UIManagerStateEnum.Card8_plungerPress);
